...
import { getCookie, setUserData } from '../../store/slices/userSlice';
...
const EditProfile = ({ history }) => {
  ...
  return (
    <div className={style['edit-profile']}>
      <h3 className={style['edit-profile__title']}>Edit Profile</h3>
      <form className={style['edit-profile__form']} onSubmit={handleSubmit(onSubmit)}>
        <label>
          Username
          <input
            className={style['edit-profile__input']}
        ...
        <button className={style['edit-profile__submit']} type="submit">
          Save
        </button>
      </form>
    </div>
