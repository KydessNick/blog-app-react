...
const ArticleCard = (props) => {
  ...
  return (
    <div className={classesCard['article-list-item']}>
      <header className={classesCard['article-list-item__header']}>
        <div className={classesCard['article-list-item__left']}>
          <div className={classesCard['article-list-item__title-container']}>
            <Link className={classesCard['article-list-item__title']} to={`articles/${slug}`}>
              {title}
            </Link>
        ...
        <div className={classesCard['article-list-item__right']}>
          <div className={classesCard['article-list-item__user']}>
            ...
            <span className={classesCard['article-list-item__date']}>{format(new Date(updatedAt), 'MMMM d, y')}</span>
          </div>
          {author.image ? <Avatar size={46} src={author.image} /> : <Avatar size={46} icon={<UserOutlined />} />}
        </div>
      </header>
      <main className={classesCard['article-list-item__main']}>
