...
import { setCookie, setUserData } from '../../store/slices/userSlice';
...
const SignUp = ({ history }) => {
  ...
  return (
    <div className={style['sign-up']}>
      <h3 className={style['sign-up__title']}>Create new account</h3>
      <form className={style['sign-up__form']} onSubmit={handleSubmit(onSubmit)}>
        <label>
          Username
          <input
            className={style['sign-up__input']}
        ...
        <div className={style['sign-up__accept']}>
          <label className={style['sign-up__label-checkbox']}>
            <input
              className={style['sign-up__checkbox']}
        ...
        <button className={style['sign-up__submit']} type="submit">
          Create
        </button>
      </form>
      <span className={style['sign-up__footer']}>
        Don't have an account?{' '}
        <Link to="/sign-in" className={style['sign-up__link']}>
          Sign In
        </Link>
        .
      </span>
